To use Firebase authentication we go to tools from Andoid studio then click firebase and we followed the rules from there..Firebase must be logged in from 
your browser .
